...
- `rg -n "mean_reversion" apps/reference/config_loader.py`
...
| Deprecated `trading.mean_reversion` | `apps/reference/config_loader.py:353-366` | strict → `ValueError`, non-strict → `LOG.warning` | OK (в strict забороняє дублікати) |
