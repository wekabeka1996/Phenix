...
| TradingConfig.feature_engineering | add_null | None | config/aurora/trading.yaml | trading.feature_engineering |
| PositionSizingConfig.risk_fraction_q | add_null | None | config/aurora/trading.yaml | trading.domains.decision_making.position_sizing.risk_fraction_q |
| PositionSizingConfig.liquidity_kappa_mode | add_null | None | config/aurora/trading.yaml | trading.domains.decision_making.position_sizing.liquidity_kappa_mode |
| PositionSizingConfig.risk_contract_v1 | add_null | None | config/aurora/trading.yaml | trading.domains.decision_making.position_sizing.risk_contract_v1 |
...
| AuroraConfig.domains | add_null | None | config/aurora/domains.yaml | domains |
| AuroraConfig.strategies_registry | add_null | None | config/aurora/strategies.yaml | strategies_registry |
| AuroraConfig.models | skip | {'sma_trend': {'sma_short_period': 10, 'sma_long_period': 50, 'confidence_multiplier': 20.0, 'confidence_min': 0.5, 'confidence_max': 0.95}, 'volatility': {'enabled': True, 'atr_period': 14, 'atr_sma_length': 100, 'threshold_multiplier': 2.0, 'low_vol_multiplier': 0.5, 'high_vol_confidence_multiplier': 2.0, 'low_vol_confidence_multiplier': 3.0}, 'mean_reversion': {'threshold': 0.005, 'confidence_multiplier': 100.0}} | config/aurora/regime.yaml | models |

Summary: 6 to add, 30 already exist
