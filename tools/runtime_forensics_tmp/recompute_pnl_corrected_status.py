...
for rt in reported_trades:
    ...
    if active_close:
        ...
        # Check quantity mismatch for PARTIAL
        if close_qty > 0 and abs(close_qty - entry_qty) > 1e-5:
            terminal_status = "PARTIAL"
    elif close_fills:
        # Reconstruct from fills
...
print("Recomputed vs Reported Totals (with quantity mismatch check):")
status_counts = {}
pnl_sums = {}
fee_sums = {}
...
print(f"\nWin Rate metrics on CLOSED_EXACT:")
