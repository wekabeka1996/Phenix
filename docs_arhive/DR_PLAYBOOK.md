...
2. **Fetch Latest Snapshot** (⏱️ ~30 seconds)
...
3. **Load Base State** (⏱️ ~10 seconds)
...
4. **Fetch WAL Segments** (⏱️ ~60 seconds)
...
5. **Replay Events** (⏱️ ~120 seconds for 1000 events)
...
6. **Resume Normal Operations** (⏱️ ~30 seconds)
