...
class LiveFeatureCollector:
    def __init__(self, symbols: list[str]):
        ...
        # Use live Binance (not testnet)
        exchange = "binance.com"
        logger.info(f"Using live exchange: {exchange}")
        ...
        for symbol in symbols:
            ...
            logger.info(f"Created live stream for {symbol}: {stream_id}")
    ...
    def collect_features(self, duration_seconds: int = 30):
        ...
        logger.info("Live feature collection completed.")
...
def main():
    ...
    print("\n=== Live Feature Collection Summary ===")
