...
from ..manage.bracket_math import compute_bracket_targets
from apps.reference.domains.execution_position.utils import (
    quantize_stop_price,
)
from ...guards.qty_normalizer import normalize_qty
from ..manage.pending_brackets_wal import write_pending_brackets_stored
from .open_submission_adapter import (
...
from ...contract_layer.terminal_order_contracts import (
...
try:
    from ..manage.fsm_manage import validate_not_immediate
except ImportError:
