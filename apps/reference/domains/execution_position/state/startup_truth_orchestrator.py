...
from .truth_hardening import get_execution_truth_hardening
...
LOG = logging.getLogger(
    "apps.reference.domains.execution_position.startup_truth_orchestrator"
)
...
class StartupTruthOrchestrator:
    ...
    def _append_startup_truth_artifact_record(
        ...
        *,
        ...
        bounded_replay_summary: Optional[ExecutionPositionStartupTruthReplaySummary] = None,
    ) -> bool:
        ...
        try:
            record = ExecutionPositionStartupTruthRecord(
                ...
                bounded_replay_summary=bounded_replay_summary,
    ...
    def _bounded_startup_replay_summary(
        ...
        *,
        ...
        try:
            replay_summary = replay_w5_bounded_startup_subset(
                symbols_considered=normalized_symbols,
            )
            return ExecutionPositionStartupTruthReplaySummary.model_validate(
