...
Canonical location:
- execution_position domain infrastructure layer.
"""
...
LOG = logging.getLogger(
    "apps.reference.domains.execution_position.infra.order_ledger"
)
...
class OrderLedger:
    ...
    def update_order_status_by_client_id(
        self, client_order_id: str, new_status: OrderStatus
    ) -> bool:
