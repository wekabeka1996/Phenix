...
class FailureReasonCode(str, Enum):
    ...
    INSUFFICIENT_REAL_EXECUTED_ROWS = "INSUFFICIENT_REAL_EXECUTED_ROWS"
    SYNTHETIC_FALLBACK_PRESENT = "SYNTHETIC_FALLBACK_PRESENT"
    REWARD_INVALID = "REWARD_INVALID"
    REWARD_METHODOLOGY_MISSING = "REWARD_METHODOLOGY_MISSING"
    TERMINAL_OUTCOME_INCOMPLETE = "TERMINAL_OUTCOME_INCOMPLETE"
