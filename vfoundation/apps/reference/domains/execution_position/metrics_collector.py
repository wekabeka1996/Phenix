...
class MetricsCollector:
    ...
    def __init__(self, window_size_minutes: int = 60):
        ...
        self._rolling_data = deque(maxlen=10000)  # Store last 10k events

        # Per-symbol metrics
        self._symbol_metrics = defaultdict(
            lambda: {
                "intents": 0,
                "accepted": 0,
                "rejected": 0,
    ...
    def record_trade_decision(
        self, symbol: str, side: str, decision: str, reason: str = None, **extra_data
    ) -> None:
    ...
    def get_rejection_patterns(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            total_rejections = (
                self._metrics["guard_rejections_cooldown"] + self._metrics["guard_rejections_other"]
            )
