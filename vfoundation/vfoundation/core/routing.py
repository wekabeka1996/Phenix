    ...
    def route(self, msg: Message) -> Message:
        ...
        try:
            ...
            if msg.op in ["DEC", "CMD"]:
                if not msg.sig:
                    return self._error_response(msg, "SIGNATURE_REQUIRED", "DEC/CMD ops require signature", status_code=401)
                ...
                try:
                    ...
                    if not verify(payload, signature_bytes):
                        return self._error_response(msg, "SIGNATURE_INVALID", "signature verification failed", status_code=401)
                except Exception as e:
                    return self._error_response(msg, "SIGNATURE_ERROR", f"signature error: {str(e)[:40]}", status_code=401)
