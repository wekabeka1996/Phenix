...
def temp_wal_dir():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        test_records = [
            ...
            {"op": "DEC", "verb": "OPEN", "rid": "RID-123", "src": "risk", "dst": "execpos", 
             "why": "open position", "pld": {"symbol": "BTCUSDT", "qty": 0.001}, 
             "_hash": "hash1", "timestamp": 1000.0},
            {"op": "EVT", "verb": "ORDER_PLACED", "rid": "RID-123", "src": "exchange", "dst": "execpos",
             "why": "order placed", "pld": {"symbol": "BTCUSDT", "order_id": "O123"},
             "_hash": "hash2", "timestamp": 1001.0},
            
            # RID-456: CLOSE decision without matching event (FP)
            {"op": "DEC", "verb": "CLOSE", "rid": "RID-456", "src": "risk", "dst": "execpos",
             "why": "close position", "pld": {"symbol": "ETHUSDT", "qty": 0.01},
             "_hash": "hash3", "timestamp": 2000.0},
            
            # RID-789: Event without decision (FN)
            {"op": "EVT", "verb": "FILL", "rid": "RID-789", "src": "exchange", "dst": "execpos",
             "why": "fill received", "pld": {"symbol": "SOLUSDT", "fill_qty": 1.0},
             "_hash": "hash4", "timestamp": 3000.0},
        ]
...
class TestReplayCommand:
    ...
    def test_replay_success_with_shadow_mode(self, temp_wal_dir, monkeypatch):
        ...
        report_path = pathlib.Path(temp_wal_dir) / "ops" / "reports" / "rid_RID-123.json"
    ...
    def test_replay_custom_output_path(self, temp_wal_dir, monkeypatch):
        ...
        result = runner.invoke(app, ["replay", "RID-123", "--shadow", "--output", str(custom_output)])
