...
class TestStrategyGatewayTimeContract:
    ...
    def test_reduce_only_exits_exempt_from_ts_ms_missing(self, gateway):
        ...
        gw, dm = gateway
        dm._get_portfolio_position_qty_signed.return_value = (Decimal("1.0"), "BTCUSDT")
        
        # Test FULL_CLOSE
        msg_full = self._make_msg(None, intent_kind="FULL_CLOSE", strategy_id="md_amr")
        ...
        msg_partial = self._make_msg("", intent_kind="PARTIAL_CLOSE", strategy_id="md_amr")
    ...
    def test_reduce_only_with_invalid_ts_ms_fails_closed(self, gateway):
        ...
        msg = self._make_msg("abc", intent_kind="FULL_CLOSE", strategy_id="md_amr")
        gw.process_signal(msg)
