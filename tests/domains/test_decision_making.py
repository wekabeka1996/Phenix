...
def test_decision_making_aggregates_events_and_proposes_intent(
    decision_making_domain, caplog
):
    """
    ...
    decision_making_domain.on_features(
        features_msg
    )  # Features event triggers the decision
