...
class TestAuroraAlphaAdapter:
    ...
    def test_adapter_initialization(self):
        ...
        assert adapter.name == "aurora_v2_adapter"
        assert adapter.get_required_features() == ["obi", "delta_price", "macro_resid"]
    ...
    def test_calculate_alpha_with_valid_features(self):
        ...
        assert result.model_name == "aurora_v2_adapter"
...
class TestAuroraAdapterIntegration:
    ...
    def test_adapter_matches_kernel_sign(self):
        """Adapter score should have same sign as direct kernel call."""
        from apps.reference.domains.decision_making.aurora_scoring_kernel import (
            AuroraScoringKernel, SideBiasState
        )
