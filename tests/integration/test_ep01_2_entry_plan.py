...
class TestEntryPlanObiModulation:
    ...
    def test_long_bullish_obi_reduces_offset(self, obi_params):
        ...
        result_bull = ep.compute(side="BUY", ref_price="100.0", atr="2.0", obi="0.5")
        result_neutral = ep.compute(side="BUY", ref_price="100.0", atr="2.0", obi="0.0")
    ...
    def test_short_bullish_obi_increases_offset(self, obi_params):
        ...
        result_bull = ep.compute(side="SELL", ref_price="100.0", atr="2.0", obi="0.5")
        result_neutral = ep.compute(side="SELL", ref_price="100.0", atr="2.0", obi="0.0")
...
class TestEntryPlanClamp:
    ...
    def test_extreme_obi_clamped_to_min(self, clamp_params):
        ...
        result = ep.compute(side="BUY", ref_price="100.0", atr="2.0", obi="1.0")
    ...
    def test_extreme_obi_clamped_to_max(self, clamp_params):
        ...
        result = ep.compute(side="SELL", ref_price="100.0", atr="2.0", obi="1.0")
    ...
    def test_moderate_obi_not_clamped(self, clamp_params):
        ...
        result = ep.compute(side="SELL", ref_price="100.0", atr="2.0", obi="0.3")
...
class TestTradeIntentSchema:
    ...
    def schema(self):
        ...
        if not schema_path.exists():
            ...
            schema_path = Path("/home/wekabeka/Музыка/Phenix/apps/reference/domains/decision_making/schemas/trade_intent_v1.json")
