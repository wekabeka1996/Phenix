...
def full_system():
    ...
    config = {
        "trading": {
            "instruments": {
                "BTCUSDT": {
                    "leverage": 10, "margin_type": "isolated", "min_qty": "0.001",
                    "step_size": "0.001", "tick_size": "0.01", "min_notional": "10",
                }
            },
        ...
        "account_balance": {},
        "binance_ro_api_key": "test", "binance_ro_api_secret": "test",
        "trading_env": "test",
    }
    ...
    mock_adapter.place_order = MagicMock(return_value={"status": "FILLED", "orderId": "123"})
...
def test_happy_path_lifecycle(full_system):
    ...
    fill_payload = {
        "symbol": "BTCUSDT", "side": "buy", "quantity": "0.1", "price": "10000.0",
        "fees": "0.04", "ts": time.time(), "venue": "simulated"
    }
