...
class TestFsmSmartExtract:
    ...
    def test_resolve_price_from_root(self):
    ...
    def test_resolve_price_from_price_ctx(self):
        """
    ...
    def test_resolve_price_from_order(self):
    ...
    def test_resolve_price_priority_root_over_price_ctx(self):
    ...
    def test_resolve_price_priority_price_ctx_over_order(self):
    ...
    def test_resolve_price_returns_none_for_missing(self):
    ...
    def test_resolve_price_ignores_null_values(self):
    ...
    def test_resolve_price_ignores_empty_string(self):
...
class TestMetadataExtraction:
    ...
    def test_tca_budget_extraction(self):
    ...
    def test_risk_context_extraction(self):
