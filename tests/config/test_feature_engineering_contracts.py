...
CONTRACT_CASES = {
    ...
    "LargeTradeImbalanceConfig": {
        "required": {"window_ms", "min_trades", "eps", "use_notional"},
    ...
    "MacroResidConfig": {
        "required": {"beta_window", "mad_window", "winsor_percentile", "var_floor", "scale_floor", "clip"},
        "defaults": {"enabled": True, "neutral": 0.0},
        "class_factories": {},
    },
    "AbsorptionProxyConfig": {
        "required": {"source", "window", "eps"},
        "defaults": {"dp_cap_pct": None},
        "class_factories": {},
    },
    ...
    "PillarWeightsConfig": {
        "required": set(),
        "defaults": {"tactician": 0.3, "operator": 0.4, "strategist": 0.3},
        "class_factories": {},
    },
    "PillarBackfillConfig": {
        "required": set(),
        "defaults": {"enabled": True, "d1_candles": 200, "h4_candles": 100, "m15_candles": 50},
        "class_factories": {},
    },
    "PillarsConfig": {
        "required": set(),
        ...
        "class_factories": {
            ...
            "weights": "PillarWeightsConfig",
            "backfill": "PillarBackfillConfig",
        },
    },
    "LegacyFeaturesLogConfig": {
        "required": set(),
        "defaults": {"mode": "full", "sample_every_n": 10},
        "class_factories": {},
    },
    "FeatureEngineeringDomainConfig": {
        ...
        "class_factories": {"legacy_features_log": "LegacyFeaturesLogConfig"},
    },
}
...
def test_feature_engineering_yaml_contract_fails_closed_on_missing_absorption_dp_cap(
    ...
    assert "required when mode='full'" in message
