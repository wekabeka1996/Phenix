...
|-------------------------------------------------|------------|
| validate_trading_mode_consistency               | silent (auto-coerces; no failure path) |
| _backcompat_root_execution_alias                | silent (assignment only; no failure path) |
...
REQUIRED_CROSS_VALIDATORS = (
    ...
    "_backcompat_root_execution_alias",
