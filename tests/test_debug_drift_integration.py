...
from vfoundation.obs.debug_api import debug_rid, add_drift_report, _drift_reports, _drift_lock
from apps.reference.domains.execution_position.drift_monitor import (
    DriftReport, ConfusionMatrix, Mismatch
)
...
def test_debug_with_multiple_reports_finds_matching():
    ...
    report1 = DriftReport(confusion=confusion1, mismatches=[mismatch1], records_processed=6)
    ...
    report2 = DriftReport(confusion=confusion2, mismatches=[mismatch2], records_processed=11)
...
def test_debug_limits_mismatches_to_5():
    ...
    report = DriftReport(confusion=confusion, mismatches=mismatches, records_processed=10)
