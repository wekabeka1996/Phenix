...
def test_cb_full_cycle_controlled_clock(
    ...
    with patch("time.time_ns", side_effect=mock_time_ns):
        ...
        assert store._cb_open_until_ns > current_time_ns[0], "CB should set cooldown deadline"
        ...
        assert store.metrics.idemp_cb_open_total > open_count_before, "CB open counter should increment"
        ...
        assert store._cb_state == "HALF_OPEN", "CB should transition to HALF_OPEN after cooldown"
