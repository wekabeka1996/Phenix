...
class TestStrategyRegimeConfig:
    ...
    def test_null_allowed_regimes_allows_all(self):
        """None allowed_regimes means no restriction."""
        config = StrategyRegimeConfig(
            symbol="BTCUSDT",
            strategy="aurora",
        ...
        assert config.allows_mr_regimes is True
        assert config.allows_aurora_regimes is True
...
class TestExplainBlocking:
    ...
    def test_explain_no_restriction(self):
        """Should explain when no restriction exists."""
        explanation = RegimeAllowlistContract.explain_blocking(
            symbol="BTCUSDT",
            current_regime="TREND_UP",
            allowed_regimes=None,
        ...
        assert "No regime restriction" in explanation
        assert "all allowed" in explanation
