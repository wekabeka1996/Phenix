...
@pytest.mark.parametrize("features_payload, expected_regime", [
    ...
    ({"price": "4000", "sma_short": "4001", "sma_long": "4002", "atr_14": "150", "atr_14_sma_100": "70"}, "HIGH_VOLATILITY"),
    
    # LOW_VOLATILITY: ATR calm (0.43x below average)
    ({"price": "4000", "sma_short": "4001", "sma_long": "4002", "atr_14": "30", "atr_14_sma_100": "70"}, "LOW_VOLATILITY"),
])
def test_emitted_event_conforms_to_schema(regime_detector, features_payload, expected_regime):
    ...
    for field in required_fields:
        assert field in emitted_payload, f"Required field '{field}' missing from payload"
...
def test_all_regime_types_covered_in_schema():
    ...
    assert not extra, \
        f"Regime types {extra} are in schema but not implemented in code"
