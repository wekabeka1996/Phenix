...
| Replay Ready Rows | 153 | rows with full geometry and recorder bars |
| Rows With Market Path | 153 | bars available after reject timestamp |
| Recorder Timeframe Distribution | {"180": 153} | chosen replay timeframe counts |
