...
- Blocks suppressed by config: 0
- Reject by NRR: {'NRR-027': 17, 'NRR-028': 3, 'NRR-062': 21, 'NRR-026': 9, 'NRR-029': 10, 'NRR-030': 1}

## Directional Follow-Through

- 1 bars: n=61 positive_rate=0.541 avg_bps=-0.99 median_bps=0.84
- 3 bars: n=60 positive_rate=0.550 avg_bps=2.32 median_bps=4.10
- 6 bars: n=60 positive_rate=0.533 avg_bps=3.65 median_bps=1.80
- 12 bars: n=59 positive_rate=0.525 avg_bps=6.61 median_bps=9.06
