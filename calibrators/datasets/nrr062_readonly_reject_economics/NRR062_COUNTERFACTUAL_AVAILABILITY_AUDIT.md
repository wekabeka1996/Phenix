...
| MARKET_PATH_AVAILABLE_ONLY | 153 | market bars only, no realized/joined outcome |
...
| Metric | Value | Notes |
| --- | --- | --- |
| Reject Rows | 153 | canonical NRR062 reject cohort |
| Decision Ledger Present | 153 | rows with frozen decision ledger trace |
| Objective Present | 153 | rows with objective stack row |
...
| Market Path Available Rows | 153 | rows with later recorder bars available by symbol/timestamp |
