# Приклад те� тового � ценарію з по� лідовні� тю подій

## Сценарій: По� лідовні� ть трейдів BTCUSDT
...
### Подія 2: Продаж ча� тини BTC (ча� тковий вихід)
```json
{
...
## Сценарій: Ви� ока ча� тота торгівлі

### Швидка по� лідовні� ть трейдів
```json
[
  {
...
### Подія пі� ля відновлення з'єднання
```json
{
...
## Те� тові дані для дедуплікації

### Повторювані трейди (для те� тування дедуплікації)
```json
[
  {
